...
import { View, Text, Image, SafeAreaView, Dimensions,StyleSheet, TouchableOpacity, TextInput, TouchableWithoutFeedback, KeyboardAvoidingView, Platform } from "react-native";
        ...
        <TouchableWithoutFeedback style= { { flex:1}} onPress={dismissKeyboard}>
            ...
            <KeyboardAvoidingView 
                ...
                <View className="items-center px-5 justify-center mt-6 ">
                    <Text className="text-base text-center  text-white font-normal ">Chọn thông tin liên hệ mà chúng tôi sẽ sử dụng để đặt lại mật khẩu của bạn.</Text>
                    <Image source={quenMK} className=" h-48 m-6"/>
                    
                    <View className="space-y-3">
                        <TouchableOpacity className="flex-row border items-center p-3 space-x-3 h-16 rounded-lg border-[#7d7d7d] " style={{width: width*0.9}}>
                ...
                <View className="px-5  space-y-16 absolute bottom-6" style={{width: width*0.99}}>
                   ...
                   >
                      ...
                      font-medium text-black leading-5 font-kanit">Tiếp tục</Text>
                   </TouchableOpacity>
                </View>
             </SafeAreaView>
