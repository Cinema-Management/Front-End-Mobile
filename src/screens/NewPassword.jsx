            ...
            <KeyboardAvoidingView 
                ...
                <View className="items-center px-5 justify-center mt-6 ">
                    ...
                    <View className=" h-auto my-3" style={{width: width*0.9}}>
                        <View className="flex-row items-center space-x-1">
                            ...
                            <Text 
                                className="text-green-700 text-center text-[12px] font-normal">
                                Chứa 1 chữ cái hoa , thường.</Text>
                        </View>
                        <View className="flex-row items-center space-x-1">
                            <Ionicons name="checkmark-circle-outline" size={20} color="green" />
                            <Text 
                                className="text-green-700 text-center text-[12px] font-normal">
                               Chứa ít nhất 1 số.</Text>
                        </View>
                        <View className="flex-row items-center space-x-1">
                            <Ionicons name="checkmark-circle-outline" size={20} color="green" />
                            <Text 
                    ...
                    <View className="space-y-3">
                        <View className="flex-row border items-center py-2 px-3 space-x-3 h-12 rounded-lg border-[#7d7d7d] " style={{width: width*0.9}}>
                ...
                <View className="px-5  space-y-16 absolute bottom-6" style={{width: width*0.99}}>
                   ...
                   >
                      ...
                      font-bold text-black leading-5 font-kanit">Xác nhận</Text>
                   </TouchableOpacity>
                </View>
             </SafeAreaView>
