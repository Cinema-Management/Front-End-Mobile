    ...
    const cinemas = [
        {
            ...
            distance: '2.1 km',
            times: ['08:00', '10:00', '12:00', '14:00', '16:00', '20:00', '21:00', '22:00'],
        },
        {
            name: 'TD Điện Biên Phủ',
            address: '651A Điện Biên Phủ, Quận 3, TP.Hồ Chí Minh',
            distance: '5.6 km',
            times: ['08:00', '10:00', '12:00', '14:00'],
        },
        {
            name: 'TD Thống Nhất',
            address: '414 Thống nhất, Quận Gò Vấp, TP.Hồ Chí Minh',
            distance: '7.1 km',
            times: ['10:00', '12:00', '14:00', '16:00'],
        },
        {
            name: 'TD Phan Văn Trị',
            address: '1014 Phan Văn Trị, Quận Gò Vấp, TP.Hồ Chí Minh',
            distance: '9.5 km',
            ...
            <View key={index} style={styles.cinemaContainer}>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                    {cinema.times.map((time, idx) => (
                        <TouchableOpacity
                            key={idx}
                            style={[styles.timeButton, time === selectedTime ? styles.selectedTimeButton : null]}
                            onPress={() => setSelectedTime(time)}
                        >
                            <Text style={[styles.timeText, time === selectedTime ? styles.selectedTimeText : null]}>
                                {time}
                            </Text>
                        </TouchableOpacity>
                    ))}
        ...
        <View style={styles.container}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.dateContainer}>
                {['Hôm nay', 'T4', 'T5', 'T6'].map((date, idx) => (
                    <TouchableOpacity
                        key={idx}
                        style={[styles.dateButton, date === selectedDate ? styles.selectedDateButton : null]}
