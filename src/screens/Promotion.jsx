...
const FirstRoute = () => (
  <View className="flex-1 bg-[#1c1c1c]" >
    <View className="items-center my-6 space-y-3 py-2">
      <View className="flex-row items-center justify-center h-24 bg-[#494949] rounded-xl px-4"
       style={{width: width*0.9}}>
        <Image source={phim1} className="h-20 w-32 rounded"/>
        <View className="flex-1 ml-3"><Text className="text-white text-base font-bold ">Giá ưu đãi cho học sinh, sinh viên</Text></View>
      </View>
...
const SecondRoute = () => (
  ...
  <View className="items-center my-6 space-y-3 py-2">
    <View className="flex-row items-center justify-center h-24 bg-[#494949] rounded-xl px-4"
     style={{width: width*0.9}}>
      <Image source={phim1} className="h-20 w-32 rounded"/>
      <View className="flex-1 ml-3"><Text className="text-white text-base font-bold ">Mừng ngày 2/9 khuyến mãi lớn</Text></View>
    </View>
  </View>
</View>
);
